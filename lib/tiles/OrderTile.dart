...
class OrderTile extends StatelessWidget {
 ...
 String _buildProductText(DocumentSnapshot snapshot){
   ...
   //LinkedHashMap lista como a do firebase
   for(LinkedHashMap p in snapshot.data["products"]){
     text += "${p["quantity"]} x ${p["product"]["title"]} (R\$ ${p["product"]["price"].toString()})\n";
   }
   text += "Total: R\$ ${snapshot.data["total"].toString()}";
   return text;

 }

  Widget _buildCircle(String title, String subtTitle, int status, int thisStatus){
